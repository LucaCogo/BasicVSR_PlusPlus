...
class BasicVSR_Farneback(nn.Module):
    """BasicVSRAFT network structure.
    ...
    Args:
        ...
        raft_pretrained (str, optional): Pre-trained model path of RAFT.
            Default: None.
    ...
    def compute_flow(self, lqs):
        ...
        # if lqs.shape[0]>30:
        #  for count, image in enumerate(lqs[1:]):
