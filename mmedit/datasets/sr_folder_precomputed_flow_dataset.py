...
class SRFolderPrecomputedFlowDataset(BaseSRDataset):
    ...
    def __init__(self,
        ...
        self.of_b_folder = str(of_b_folder)
        self.of_f_folder = str(of_f_folder)
        ...
        for ann in ann_list:
            ...
            data_infos.append(
                dict(
                    ...
                    of_b_path=self.of_b_folder,
                    of_f_path=self.of_f_folder,
                    key=key,
